...
Plot the closing prices over time to visualise the price movement.
...
for (i in 1:nrow(amd_df)) {
  current_price <- amd_df$close[i] # Redefining variable as current price
...
![tradingperiod](tradingperiod.png)
